...
const TTN_URL =
  "https://nam1.cloud.thethings.network/api/v3/as/applications/texcal-sensor-humedad/packages/storage/uplink_message";
...
export async function GET(): Promise<Response> {
  ...
  const response = await fetch(url.toString(), {
    method: "GET",
    headers: {
      Authorization: `Bearer ${process.env.TTN_API_KEY_TH}`,
